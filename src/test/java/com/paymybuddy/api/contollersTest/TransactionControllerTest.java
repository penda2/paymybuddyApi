...
import com.paymybuddy.api.controllers.TransactionController;
...
public class TransactionControllerTest {
	...
	public void showTransferTest() throws Exception {
		...
		mockMvc.perform(get("/transfert")).andExpect(status().isOk()).andExpect(view().name("transfert"))
